...
int main( void )
{
   // AAnimal *abstr = new AAnimal(); //abstract class cannot be instanciated
    ...
    AAnimal* animal_array[arraySize];
...
// //deep copies => ideas and Brain's are independent
// //shallow copie => same obj by reference
//     return 0;
// }
